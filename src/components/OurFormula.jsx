...
const OurFormula = () => {
  ...
  useEffect(() => {
    ...
    // Animate circle groups
    tl.fromTo(
      [lawGroupRef.current, designGroupRef.current, techGroupRef.current],
      {
        x: (i) =>
          i === 0
            ? initialPositions.law.x
            : i === 1
              ? initialPositions.design.x
              : initialPositions.tech.x,
        y: (i) =>
          i === 0
            ? initialPositions.law.y
            : i === 1
              ? initialPositions.design.y
              : initialPositions.tech.y,
        opacity: 0.5,
      },
      {
        x: (i) =>
          i === 0
            ? overlappedPositions.law.x
            : i === 1
              ? overlappedPositions.design.x
              : overlappedPositions.tech.x,
        y: (i) =>
          i === 0
            ? overlappedPositions.law.y
            : i === 1
              ? overlappedPositions.design.y
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-background">
      {/* Venn Diagram */}
      <div ref={containerRef} className="w-full h-[600px] flex items-center justify-center mb-16">
