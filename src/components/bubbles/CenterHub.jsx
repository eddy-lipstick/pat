...
export const CenterHub = () => {
  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      ...
      const angleDeg = (angleRadians * 180 / Math.PI) + 90; // Add 90 to adjust starting position
          ...
          <div className="bg-[#E1FF4C] rounded-full w-[120px] h-[120px] 
            ...
            <div className="w-16 h-16 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="57" height="113" viewBox="0 0 57 113" fill="none">
                <path d="M7.33813 16.1017C7.33813 16.1017 9.40091 1.96806 25.3368 0.596385C25.3368 0.596385 34.8148 0.347601 40.7402 9.3509C40.7402 9.3509 44.5085 14.414 43.4367 21.1648L42.3581 34.1016C42.3581 34.1016 41.8188 46.4802 46.6657 54.9187L19.3642 52.3569C19.3642 52.3569 18.6901 47.6502 18.6497 47.7107L13.2636 47.0383C13.2636 47.0383 9.49528 46.4735 8.95599 43.6629L8.41671 37.4769C8.41671 37.4769 4.64844 36.9121 4.64844 35.7892C4.64844 34.6664 6.2663 31.291 6.2663 31.291C6.2663 31.291 8.05943 28.0164 7.14938 24.0224C6.92018 23.0206 6.873 21.9784 6.96063 20.9563L7.34487 16.1017H7.33813Z" fill="#C7C3EC" />
                <path d="M7.33789 16.1017C7.33789 16.1017 9.40067 1.96806 25.3366 0.596385C25.3366 0.596385 34.8146 0.347601 40.74 9.3509C40.74 9.3509 44.5083 14.414 43.4364 21.1648L42.3579 36.3541C42.3579 36.3541 31.0463 31.8558 28.8892 25.6631C29.4284 22.8525 27.2713 21.7229 27.2713 21.7229C27.2713 21.7229 25.1142 20.0352 22.4245 22.2877L21.8852 22.8525C21.8852 22.8525 20.2673 25.6631 18.1169 23.4173L7.34463 16.1017H7.33789Z" fill="#231E6E" />
                <path d="M39.0868 46.3702L23.7262 50.8451C22.121 51.3142 20.9892 52.7268 20.8913 54.382L15.6914 69.007L0.664062 99.0235L3.30876 100.275C20.0544 108.197 39.4459 108.311 56.2834 100.586C56.2834 100.586 55.4991 70.0133 42.4495 46.8986C41.4701 46.23 40.2349 46.0467 39.0977 46.3756L39.0868 46.3702Z" fill="#030236" />
                <path d="M24.3031 51.2544V77.054H9.72461L19.099 52.8345L24.3031 51.2544Z" fill="white" />
                <path d="M47.6758 29.8389C51.585 29.8389 54.7539 26.678 54.7539 22.7788C54.7539 18.8797 51.585 15.7188 47.6758 15.7188C43.7667 15.7188 40.5977 18.8797 40.5977 22.7788C40.5977 26.678 43.7667 29.8389 47.6758 29.8389Z" fill="#231E6E" />
              </svg>
            </div>
          </div>
        </div>
        ...
        <div ref={beamRef}
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="1062" height="1062" viewBox="0 0 1062 1062" fill="none"
            ...
            <g clipPath="url(#clip0_4030_6200)">
              <path d="M531 -2.32107e-05C644.884 -2.81888e-05 755.752 36.6141 847.237 104.438L531 531L531 -2.32107e-05Z" fill="url(#paint0_linear_4030_6200)" />
            </g>
            <defs>
              <linearGradient id="paint0_linear_4030_6200" x1="542.389" y1="518.899" x2="733.15" y2="14.9476" gradientUnits="userSpaceOnUse">
